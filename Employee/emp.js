            ...
            col.innerHTML = `
                <div class="employee-card d-flex flex-column h-100">
                    <div class="d-flex align-items-center mb-3">
                        <img src="${emp.profileImage}" alt="${initials}" class="avatar-img">
                        <div>
