document.addEventListener("DOMContentLoaded", () => {
    // Initialize localStorage employee data if not present
            ...
            "employeeInformation": [
                {
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVz13n5__CJit9WIsOztZ4fdZdZmrV_RRHwg&s",
                    "status": "Active"
                },
                {
                    "employeeId": 2,
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToonwNT4zbwCyq-k-qAzXexPn6URz3gT4BxQ&s",
                    "status": "Active"
                },
                {
                    "employeeId": 3,
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMTYDFHOsEqWaxITzH0YETeYXQw6fvastO8Q&s",
                    "status": "Active"
                },
                {
                    "employeeId": 4,
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkAkWcI0LFLuWTfiyCMiwl8TvYT_FsflDV1g&s",
                    "status": "Active"
                },
                {
                    "employeeId": 5,
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUxarmEAWMbWnfZHQ8QVE6fZgR0fBe-63RSQ&s",
                    "status": "On Leave"
                },
                {
                    "employeeId": 6,
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS94d9Pn8Pjsqw4yz2zRDTzZeyeXWwT26Lxqw&s",
                    "status": "On Leave"
                },
                {
                    "employeeId": 7,
                ...
                },
                {
                    ...
                    "profileImage": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQitWKXOGriZKh7u3b1VtWjNj8Ib7ld9rj_oA&s",
                    "status": "Active"
                },
                {
                    "employeeId": 9,
    ...
    let departments = [...new Set(employees.map((e) => e.department))];
    ...
    function renderEmployeeCards(data) {
        ...
        data.forEach((emp, index) => {
            ...
            // Use imgSrc with fallback if profileImage missing or empty
            const imgSrc = emp.profileImage && emp.profileImage.trim() !== ""
                ? emp.profileImage
          ...
          <div class="employee-card d-flex flex-column h-100">
            <div class="d-flex align-items-center mb-3">
              <img src="${imgSrc}" alt="${initials}" class="avatar-img" style="width: 80px; height: 80px; border-radius: 50%;"
                onerror="this.onerror=null;this.src='https://via.placeholder.com/80x80.png?text=${initials}'" />
              <div class="ms-3">
                <h5 class="mb-0">${emp.name}</h5>
                <small class="text-muted">EMP${emp.employeeId.toString().padStart(3, "0")}</small>
              </div>
            </div>
            <p class="mb-1"><strong>Position:</strong><br>${emp.position}</p>
            <p class="mb-1"><strong>Department:</strong><br>${emp.department}</p>
            <p class="mb-1"><strong>Salary:</strong><br>R ${emp.salary.toLocaleString()}</p>
            <div class="mb-2">
              <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#${cardId}" aria-expanded="false" aria-controls="${cardId}">
                View History
              </button>
              <div class="collapse mt-2" id="${cardId}">
                <p class="mb-0"><strong>Employment History:</strong><br>${emp.employmentHistory}</p>
              </div>
            </div>
            <p class="mt-auto"><strong>Status:</strong><br>
    ...
    // Filter employees by search text and department, then render
    ...
    // Event listener for custom event employeeStatusUpdated to re-render employees
    document.addEventListener("employeeStatusUpdated", () => {
        const updatedEmployees = JSON.parse(localStorage.getItem("employeeData")) || [];
        renderEmployeeCards(updatedEmployees);
    });
});
